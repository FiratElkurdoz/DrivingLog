...
/*The instance of this class is called by "Map_page",to get the time taken reach the destination from Google Distance Matrix API in background.
  This class contains interface "Geo" to call the function setDouble(String) defined in "Map_page.class" to display the result.*/
